...
- _release_: V1.4.0 notes


#### Features

- Enable vagrant scenario for collections by default

- _collection_: Immutable plain-SemVer release tags for both release tracks
...
- _templates_: Exclude tests/output from ansible-lint


#### Documentation

- _release_: V1.3.4 notes
